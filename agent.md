...
- `blueprint.md` for product scope and behavior
- `architecture.md` for system boundaries and request flow
- `supabase.md` plus `supabase/migrations/` for database and migration rules
- `design.md` for UI direction and interaction tone
...
- Before changing schema behavior, check `supabase.md` and the existing migration files first.
...
- Read `design.md` before any meaningful UI or interaction change.
...
- When changing behavior, keep the relationship between `blueprint.md`, `architecture.md`, and `supabase.md` coherent.
